...
Download **ISIC2018 Task 1 (Lesion Boundary Segmentation)** from the [ISIC Archive](https://challenge.isic-archive.com/landing/2018/) and organize it as follows:

data/
├── ISIC2018_Task1-2_Training_Input/ # 2594 original images
├── ISIC2018_Task1_Training_GroundTruth/ # 2594 ground-truth masks
├── ISIC2018_Task1-2_Validation_Input/ # 100 validation images
└── ISIC2018_Task1_Validation_GroundTruth/ # 100 validation masks
...
### 4. Launch the Web System

bash

Configure the iFlytek Spark API credentials
...
│ ├── multiresunet.py
│ ├── doubleunet.py
│ └── improved_doubleunet.py # This project’s improved architecture
├── modules/
│ ├── multires_block.py # MultiResBlock
│ └── respath.py # ResPath
├── data/ # Dataset (gitignored)
├── utils/
│ ├── dataset.py # PyTorch Dataset and data augmentation
│ ├── metrics.py # IoU, Dice, Precision, Recall
│ └── visualize.py # Boundary overlay and region coloring
...
├── spark_client.py # iFlytek Spark LLM client
├── requirements.txt
